        ...
        try {
            ...
            switch(table) {
                case "learner_tbl":
                    ...
                    "learner_id INT AUTO_INCREMENT NOT NULL, parent_id INT, names VARCHAR(100), last_name VARCHAR(100), date_of_birth VARCHAR(10), gender VARCHAR(10), grade INT, age INT, subject1 VARCHAR(45), subject2 VARCHAR(45), subject3 VARCHAR(45), subject4 VARCHAR(45), subject5 VARCHAR(45), subject6 VARCHAR(45), subject7 VARCHAR(45), PRIMARY KEY(learner_id), FOREIGN KEY(parent_id) REFERENCES parent_tbl(parent_id))";
                    break;
                case "parent_tbl":
                    sql = "CREATE TABLE IF NOT EXISTS " + table + "(" +
